...
public class CaptionService {
  ...
  private static final String SYSTEM =
      "You write short, algorithm-friendly social captions. Non-explicit, confident. Output strict JSON: {caption, hashtags} where hashtags is an array (<=3).";
...
""";
  ...
  public CaptionService(Config cfg) {
    this.apiKey = cfg.openaiKey();
  ...
  public Caption generate(String title, String collaborator) throws Exception {
    ...
    Request req =
        new Request.Builder()
            ...
            .post(
                RequestBody.create(M.writeValueAsBytes(body), MediaType.parse("application/json")))
            .build();
