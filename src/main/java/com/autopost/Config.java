...
public record Config(
  ...
  static String req(String k) {
    var v = System.getenv(k);
    if (v == null || v.isBlank()) throw new RuntimeException(k + " is required");
    return v;
  }

  public boolean hasInlineSA() {
    return saInlineJson() != null && !saInlineJson().isBlank();
  }

  public boolean hasSAPath() {
    return saPath() != null && !saPath().isBlank();
  }
}
